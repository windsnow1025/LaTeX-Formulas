...
\]
\[
    \frac{\partial^2 f}{\partial \mathbf{x} \partial \mathbf{x}^T} = \mathbf{H}_\mathbf{x}^T(f)
\]
The Jacobian matrix of the Gradient of $f$.
\[
    \mathbf{H}^T(f) = \mathbf{J}(\nabla f)
\]
...
\]
\[
    \nabla f(\mathbf{x}) = \frac{1}{2}(A + A^T)\mathbf{x} = A\mathbf{x}
\]
\[
    \mathbf{H}^T(f(\mathbf{x})) = A
\]
...
\]
\[
    \nabla_{\mathbf{t}}^T f = \nabla_{\mathbf{x}}^T f \cdot \mathbf{J}_{\mathbf{x} \to \mathbf{t}}
\]
\[
