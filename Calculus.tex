...
$f: \mathbb{R}^n \to \mathbb{R}$, $f = f(\mathbf{x})$. Use \textbf{Denominator Layout}.
...
$\mathbf{f}: \mathbb{R}^n \to \mathbb{R}^m$, $\mathbf{f}(\mathbf{x}) = \mathbf{y}$. Use \textbf{Numerator Layout}.
