...
\]
where $\mathbb{P}(H|E)$ is \textbf{Posterior}, $\mathbb{P}(H)$ is \textbf{Prior}, $\mathbb{P}(E|H)$ is \textbf{Likelihood}, $\mathbb{P}(E)$ is \textbf{Marginal Likelihood}.
...
\[
    f(\mathbf{x}) = \frac{1}{(2\pi)^{d/2} \sigma^d} \exp\left(-\frac{\|\mathbf{x} - \boldsymbol{\mu}\|^2}{2\sigma^2}\right)
\]
