...
Let $\mathbf{x} = (x_1, \dots, x_k)^\top$ be a one-hot vector, $\mathbf{p} = (p_1, \dots, p_k)^\top$. $\displaystyle \sum_{i=1}^{k} x_i = 1$, $\displaystyle \sum_{i=1}^{k} p_i = 1$.
...
Let $\mathbf{x} = (x_1, \dots, x_k)^\top$ be a one-hot vector, $\mathbf{p} = (p_1, \dots, p_k)^\top$. $\displaystyle \sum_{i=1}^{k} x_i = n$, $\displaystyle \sum_{i=1}^{k} p_i = 1$.
